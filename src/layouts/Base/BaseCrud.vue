      ...
      <div class="ibox-content">
        ...
        >
          ...
          <div slot="actions" slot-scope="props">
            ...
            <a
              v-show="enableEditModal"
              @click="editModal(props.row.id)"
              data-toggle="tooltip"
              title="Editar"
          ...
          <div slot="color" slot-scope="props">
            <div
              class="box"
              v-bind:style="{ 'background-color': props.row.color }"
            ></div>
          ...
          <div slot="qrcodeid" slot-scope="props">
            <qrcode-vue
              ...
              size="70"
              :value="
                props.row.qrcodeid ? props.row.qrcodeid + '' : props.row.id + ''
              "
              level="H"
            ></qrcode-vue>
          </div>
